...
from thunder.filters import command
from thunder.command import commandpro
...
**""",
    reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "ʜᴇʟᴘ & ᴄᴏᴍᴍᴀɴᴅꜱ", url=f"https://t.me/thundermusicsupport/160"
                    ),
                    InlineKeyboardButton(
                        "ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ", url="https://github.com/THUNDERMUSIC-AI/MUSIC"
                    )
                ],
                [
                    InlineKeyboardButton(
    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        " ʀᴇᴘᴏ ⚒️", url=f"https://github.com/THUNDERMUSIC-AI/MUSIC")
                ]
            ]
        ),
    )
